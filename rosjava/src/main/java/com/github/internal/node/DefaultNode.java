...
import com.github.Parameters;
import com.github.concurrent.CancellableLoop;
import com.github.concurrent.ListenerGroup;
import com.github.concurrent.SignalRunnable;
...
import com.github.internal.node.client.Registrar;
import com.github.internal.node.parameter.DefaultParameterTree;
import com.github.internal.node.parameter.ParameterManager;
import com.github.internal.node.response.Response;
import com.github.internal.node.response.StatusCode;
import com.github.internal.node.server.NodeIdentifier;
import com.github.internal.node.server.SlaveServer;
import com.github.internal.node.service.ServiceDeclaration;
import com.github.internal.node.service.ServiceFactory;
import com.github.internal.node.service.ServiceIdentifier;
import com.github.internal.node.service.ServiceManager;
import com.github.internal.node.topic.PublisherFactory;
import com.github.internal.node.topic.SubscriberFactory;
import com.github.internal.node.topic.TopicDeclaration;
import com.github.internal.node.topic.TopicParticipantManager;
import com.github.internal.node.xmlrpc.XmlRpcTimeoutException;
...
import com.github.namespace.NodeNameResolver;
import com.github.node.ConnectedNode;
import com.github.node.DefaultNodeFactory;
import com.github.node.Node;
import com.github.node.NodeConfiguration;
import com.github.node.NodeListener;
import com.github.node.parameter.ParameterTree;
...
import com.github.node.topic.DefaultPublisherListener;
import com.github.node.topic.DefaultSubscriberListener;
import com.github.node.topic.Publisher;
import com.github.node.topic.Subscriber;
import com.github.node.topic.TransportHints;
import com.github.time.ClockTopicTimeProvider;
import com.github.time.TimeProvider;
...
public class DefaultNode implements ConnectedNode {
  ...
  private <T> com.github.message.MessageSerializer<T> newMessageSerializer(String messageType) {
  ...
  public <T> Publisher<T> newPublisher(GraphName topicName, String messageType) {
    ...
    com.github.message.MessageSerializer<T> serializer = newMessageSerializer(messageType);
