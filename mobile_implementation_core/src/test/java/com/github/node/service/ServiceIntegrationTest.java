...
public class ServiceIntegrationTest extends RosTest {
  ...
  public void testPesistentServiceConnection() throws Exception {
    final CountDownServiceServerListener<mobile_implementation_core_test_msgs.AddTwoIntsRequest, mobile_implementation_core_test_msgs.AddTwoIntsResponse> countDownServiceServerListener =
    ...
    nodeMainExecutor.execute(new AbstractNodeMain() {
      ...
      public void onStart(final ConnectedNode connectedNode) {
        ServiceServer<mobile_implementation_core_test_msgs.AddTwoIntsRequest, mobile_implementation_core_test_msgs.AddTwoIntsResponse> serviceServer =
            connectedNode
                .newServiceServer(
                    SERVICE_NAME,
                    mobile_implementation_core_test_msgs.AddTwoInts._TYPE,
                    new ServiceResponseBuilder<mobile_implementation_core_test_msgs.AddTwoIntsRequest, mobile_implementation_core_test_msgs.AddTwoIntsResponse>() {
                      @Override
                      public void build(mobile_implementation_core_test_msgs.AddTwoIntsRequest request,
                          mobile_implementation_core_test_msgs.AddTwoIntsResponse response) {
                        response.setSum(request.getA() + request.getB());
                      }
                    });
        try {
          connectedNode.newServiceServer(SERVICE_NAME, mobile_implementation_core_test_msgs.AddTwoInts._TYPE, null);
          fail();
    ...
    nodeMainExecutor.execute(new AbstractNodeMain() {
      ...
      public void onStart(ConnectedNode connectedNode) {
        ...
        try {
          serviceClient = connectedNode.newServiceClient(SERVICE_NAME, mobile_implementation_core_test_msgs.AddTwoInts._TYPE);
          // Test that requesting another client for the same service returns
          // the same instance.
          ServiceClient<?, ?> duplicate =
              connectedNode.newServiceClient(SERVICE_NAME, mobile_implementation_core_test_msgs.AddTwoInts._TYPE);
          assertEquals(serviceClient, duplicate);
        } catch (ServiceNotFoundException e) {
          throw new RosRuntimeException(e);
        }
        mobile_implementation_core_test_msgs.AddTwoIntsRequest request = serviceClient.newMessage();
        request.setA(2);
        request.setB(2);
  ...
  public void testRequestFailure() throws Exception {
            ...
            connectedNode
                .newServiceServer(
                    ...
                    new ServiceResponseBuilder<mobile_implementation_core_test_msgs.AddTwoIntsRequest, mobile_implementation_core_test_msgs.AddTwoIntsResponse>() {
                      @Override
                      public void build(mobile_implementation_core_test_msgs.AddTwoIntsRequest request,
                          mobile_implementation_core_test_msgs.AddTwoIntsResponse response) throws ServiceException {
    ...
    nodeMainExecutor.execute(new AbstractNodeMain() {
      ...
      public void onStart(ConnectedNode connectedNode) {
        ...
        serviceClient.call(request, new ServiceResponseListener<mobile_implementation_core_test_msgs.AddTwoIntsResponse>() {
          @Override
          public void onSuccess(mobile_implementation_core_test_msgs.AddTwoIntsResponse message) {
            fail();
          }
