...
public class TopicIntegrationTest extends RosTest {
   ...
   * 
   * @see <a
   *      href="http://answers.ros.org/question/3591/rosmobile-subscriber-unreliable">bug
   *      report</a>
   * 
  ...
  private final class Listener implements MessageListener<rosmobile_test_msgs.TestHeader> {
    private final CountDownLatch latch = new CountDownLatch(10);

    private rosmobile_test_msgs.TestHeader lastMessage;

    @Override
    public void onNewMessage(rosmobile_test_msgs.TestHeader message) {
  ...
  public void testHeader() throws InterruptedException {
    nodeMainExecutor.execute(new AbstractNodeMain() {
      ...
      public void onStart(final ConnectedNode connectedNode) {
        final Publisher<rosmobile_test_msgs.TestHeader> publisher =
            connectedNode.newPublisher("foo", rosmobile_test_msgs.TestHeader._TYPE);
        connectedNode.executeCancellableLoop(new CancellableLoop() {
          @Override
          public void loop() throws InterruptedException {
            rosmobile_test_msgs.TestHeader message =
                connectedNode.getTopicMessageFactory().newFromType(rosmobile_test_msgs.TestHeader._TYPE);
    ...
    nodeMainExecutor.execute(new AbstractNodeMain() {
      ...
      @Override
      public void onStart(ConnectedNode connectedNode) {
        Subscriber<rosmobile_test_msgs.TestHeader> subscriber =
            connectedNode.newSubscriber("foo", rosmobile_test_msgs.TestHeader._TYPE);
