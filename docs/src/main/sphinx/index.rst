...
Please file bugs and feature requests on the rosmobile `issues`_ page.

In addition to the following documentation, rosmobile_core makes liberal use of
`Javadoc`_.

.. _roscore:  http://ros.org/wiki/roscore
.. _issues: https://github.com/rosmobile/rosmobile_core or https://github.com/Application-UI-UX/rosmobile_core
