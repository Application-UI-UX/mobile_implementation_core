...
public class ParameterServerTestNode extends AbstractNodeMain {
  ...
  public GraphName getDefaultNodeName() {
    return GraphName.of("rosmobile/parameter_server_test_node");
  }
  ...
  public void onStart(ConnectedNode connectedNode) {
    ...
    final Publisher<rosmobile_test_msgs.Composite> pub_composite =
        connectedNode.newPublisher("composite", rosmobile_test_msgs.Composite._TYPE);
    final Publisher<rosmobile_test_msgs.TestArrays> pub_list =
        connectedNode.newPublisher("list", rosmobile_test_msgs.TestArrays._TYPE);
    ...
    final rosmobile_test_msgs.Composite composite_m =
        topicMessageFactory.newFromType(rosmobile_test_msgs.Composite._TYPE);
    ...
    final rosmobile_test_msgs.TestArrays list_m = topicMessageFactory.newFromType(rosmobile_test_msgs.TestArrays._TYPE);
