...
public class ParameterServerTestNode extends AbstractNodeMain {
  ...
  public GraphName getDefaultNodeName() {
    return GraphName.of("mobile_implementation_core/parameter_server_test_node");
  }
  ...
  public void onStart(ConnectedNode connectedNode) {
    ...
    final Publisher<mobile_implementation_core_test_msgs.Composite> pub_composite =
        connectedNode.newPublisher("composite", mobile_implementation_core_test_msgs.Composite._TYPE);
    final Publisher<mobile_implementation_core_test_msgs.TestArrays> pub_list =
        connectedNode.newPublisher("list", mobile_implementation_core_test_msgs.TestArrays._TYPE);
    ...
    final mobile_implementation_core_test_msgs.Composite composite_m =
        topicMessageFactory.newFromType(mobile_implementation_core_test_msgs.Composite._TYPE);
    ...
    final mobile_implementation_core_test_msgs.TestArrays list_m = topicMessageFactory.newFromType(mobile_implementation_core_test_msgs.TestArrays._TYPE);
