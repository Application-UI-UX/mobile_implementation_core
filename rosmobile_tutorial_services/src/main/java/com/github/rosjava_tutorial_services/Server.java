...
public class Server extends AbstractNodeMain {
  ...
  public GraphName getDefaultNodeName() {
    return GraphName.of("rosmobile_tutorial_services/server");
  }

  @Override
  public void onStart(ConnectedNode connectedNode) {
    connectedNode.newServiceServer("add_two_ints", rosmobile_test_msgs.AddTwoInts._TYPE,
        new ServiceResponseBuilder<rosmobile_test_msgs.AddTwoIntsRequest, rosmobile_test_msgs.AddTwoIntsResponse>() {
          @Override
          public void
              build(rosmobile_test_msgs.AddTwoIntsRequest request, rosmobile_test_msgs.AddTwoIntsResponse response) {
